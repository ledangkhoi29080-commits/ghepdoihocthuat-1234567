  ...
  useEffect(() => {
    ...
    if (currentUser) {
      setForm((prev) => ({
        ...
        birthYear: currentUser.birth_year || currentUser.birthYear || prev.birthYear,
        primarySkill: currentUser.primary_skill || currentUser.primarySkill || prev.primarySkill,
        experience: currentUser.experience || prev.experience,
        haveText: currentUser.haveText || prev.haveText,
        wantText: currentUser.wantText || prev.wantText,
        goal: currentUser.goal || prev.goal,
        avatarUrl: currentUser.avatarUrl || prev.avatarUrl,
        commitmentRate: currentUser.commitment_rate || currentUser.commitmentRate || prev.commitmentRate,
        projectHistory: currentUser.project_history || currentUser.projectHistory || prev.projectHistory,
      }));
    }
  }, [currentUser]);
